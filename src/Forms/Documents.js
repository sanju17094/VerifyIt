...
const UploadDocuments = () => {
  ...
  const handleChange = (e) => {
    ...
    console.log("file ka data->> ",files[0].name)
    setFormData({
      ...formData,
      [name]: files[0],
    });
    ...
    if (files[0]) {
      ...
      console.log("_->>>", URL.createObjectURL(files[0]));
  ...
  useEffect(() => {
    async function fetchDoc() {
      ...
      if (dataResult) {
        ...
        // })
        setFormData({
          highSchoolDocument: `${URL}/${dataResult.x_marksheet?.src}` || "",
          intermediateDocument: `${URL}/${dataResult.xii_marksheet?.src}` || "",
          graduateDocument:
            `${URL}/${dataResult.graduationMarksheet?.src}` || "",
          postGraduateDocument:
            `${URL}/${dataResult.postGraduationMarksheet?.src}` || "",
          aadharCard: `${URL}/${dataResult.adharCard?.src}` || "",
          panCard: `${URL}/${dataResult.pan?.src}` || "",
          licence: `${URL}/${dataResult.licence?.src}` || "",
          voterIdCard: `${URL}/${dataResult.voterId?.src}` || "",
          offerLetter1: `${URL}/${dataResult.offerLetter[0]?.src}` || "",
          offerLetter2: `${URL}/${dataResult.offerLetter[1]?.src}` || "",
          offerLetter3: `${URL}/${dataResult.offerLetter[2]?.src}` || "",
          profilePhoto: `${URL}/${dataResult.profilePhoto?.src}` || "",
        });
